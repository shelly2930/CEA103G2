				...
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg navbar-light">
						...
						<div class="collapse navbar-collapse main-menu-item"
							...
							<ul class="navbar-nav">
								<li class="nav-item"><a class="nav-link" href=""<%=request.getContextPath()%>/house/house.do?action=listHouse_AllOrQuery"">租
										屋</a></li>
								<li class="nav-item dropdown"><a
									class="nav-link dropdown-toggle" href="blog.html"
									id="navbarDropdown_1" role="button" data-toggle="dropdown"
									aria-haspopup="true" aria-expanded="false"> 租家具 </a>
								...
								<li class="nav-item dropdown"><a
									...
									aria-haspopup="true" aria-expanded="false"> 申請代管 </a>
								...
								<li class="nav-item dropdown"><a
									...
									aria-haspopup="true" aria-expanded="false"> 修繕服務 </a>
									<div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
								...
								<li class="nav-item"><a class="nav-link"
									href="contact.html">公 告</a></li>
								<li class="nav-item"><a class="nav-link"
									href="<%=request.getContextPath()%>/back-end/indexBack.jsp">後
										台</a></li>
							</ul>
						</div>
