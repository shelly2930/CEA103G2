...
<table id="table-1">
	<tr><td>
		 <h3>租房前確認 - rentalConfirm.jsp</h3>
		 <h4><a href="<%=request.getContextPath()%>/index.jsp"><img src="<%=request.getContextPath()%>/front-end/memTen/images/back1.gif" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	...
	<tr>
		...
		<input type="file" name="mem_idcard_f" id="idcardf" required></td>
	</tr>
	<tr>
		<td>身分證背面:</td>
		...
		<input type="file" name="mem_idcard_r" id="idcardr" required></td>
	</tr>
