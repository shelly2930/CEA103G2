								 ...
								 <div class="col-md-12 form-group">
									...
									<div class="col-md-12 form-group">
						             ...
						             <div class="col-sm-12">
										 ...
										 <div class="col-lg-12">
										 <div class="col-lg-10">
										 <a href="<%=request.getContextPath()%>/back-end/furPho/listAllFurPho.jsp?fnt_it_no=${param.fnt_it_no}" 	class="btn btn-light btn-icon-split"  style="background-color:#F5E5AE">
                                        <span class="text">返回上頁</span>
                                    </a>
										<input type="hidden" name="action" value="insert_pic_from_js" >
