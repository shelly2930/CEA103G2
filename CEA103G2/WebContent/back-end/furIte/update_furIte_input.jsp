					  ...
					  <section class="checkout_area padding_top">
						 ...
						 <FORM class="row contact_form"  ACTION="<%=request.getContextPath()%>/furIte/furIte.do" name="form1" method="post" novalidate="novalidate">
								...
								<div class="col-md-7 form-group" >
								     <label for="fnt_unrent"  class="col-md-5 col-form-lgroup" >家具品項編號：</label>
						             <div class="col-sm-10">
						   					  <span><%=furIteVO.getFnt_it_no()%></span>
						              </div>			             
								</div>
	<jsp:useBean id="furPhoSvc" scope="page" class="com.furPho.model.FurPhoService" />
						...
						<!-- 		   <div class="col-md-9 form-group p_star"> -->
									...
									<div class="col-md-7 form-group">
						             ...
						             <div class="col-sm-10">
						   					  <input type="text" class="form-control" name="fnt_name"   placeholder="" value="<%= (furIteVO==null)? "" : furIteVO.getFnt_name()%>">
						              </div>			             
									</div>
									<div class="col-md-12 form-group">
								     <label for=fnt_name  class="col-md-5 col-form-lgroup" >家具圖片：
						             ...
						             <div class="col-sm-10"><c:forEach var="furPhoVO" items="${furPhoSvc.getOneFntItePics(furIteVO.fnt_it_no)}">
						   					  <img src="<%=request.getContextPath()%>/furPho/furPhoShow.do?fnt_pic_no=${furPhoVO.fnt_pic_no}"  height="100"></c:forEach></div><br>
						              </div>			             
									</div>
								...
								<div class="col-md-7 form-group"  style="display:none">
						             ...
						             <div class="col-sm-10">
						   					  <input type="text"  name="fnt_unrent" class="form-control" id="inputPassword" placeholder=""  value="<%= (furIteVO==null)? "" : furIteVO.getFnt_unrent()%>">
						              </div>			             
								</div>
								...
								<div class="col-md-7 form-group"  style="display:none">
						             ...
						             <div class="col-sm-10">
						   					  <input type="text"  name="fnt_repair" class="form-control"  placeholder=""  value="<%= (furIteVO==null)? "" : furIteVO.getFnt_repair()%>" >
						              </div>			             
								</div>	
								...
								<div class="col-md-7 form-group"  style="display:none">
						             ...
						             <div class="col-sm-10">
						   					  <input type="text" name="fnt_total"   class="form-control"  value="<%= (furIteVO==null)? "" : furIteVO.getFnt_total()%>"  placeholder="">
						              </div>			             
								</div>	
								...
								<div class="col-md-7 form-group" >
									...
									<div class="col-md-7 form-group" >
						             ...
						             <div class="col-sm-10">
						                  ...
						                  placeholder=""><%=(furIteVO==null)? "" :furIteVO.getFnt_info()%></textarea>
						              </div>			             
								</div>	
