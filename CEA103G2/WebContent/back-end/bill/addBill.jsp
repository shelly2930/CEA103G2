...
<!-- 	<tr> -->
<!-- 		<td>房客帳單編號:</td> -->
<!-- 		<td><input type="TEXT" name="bill_no" size="45"  -->
<%-- 			 value="<%= (billVO==null)? "吳永志" : billVO.getMem_no()%>" /></td> --%>
<!-- 	</tr> -->
	<tr>
		<td>會員編號:</td>
		<td><input type="TEXT" name="mem_no" size="45"
			 value="<%= (billVO==null)? "3" : billVO.getMem_no()%>" /></td>
	</tr>
	<tr>
		<td>物件編號:</td>
		<td><input type="TEXT" name="hos_no" size="45"
			 value="<%= (billVO==null)? "2" : billVO.getHos_no()%>" /></td>
	</tr>
	<tr>
		<td>帳單日期:</td>
	...
	<tr>
		...
		<td><input type="TEXT" name="bill_power" size="45"
			 value="<%= (billVO==null)? "50" : billVO.getBill_power()%>" /></td>
	</tr>
	<tr>
		<td>本月用水量:</td>
		<td><input type="TEXT" name="bill_water" size="45"
			 value="<%= (billVO==null)? "6" : billVO.getBill_water()%>" /></td>
	</tr>
<!-- 	<tr> -->
<!-- 		<td>房客繳費狀態:</td> -->
