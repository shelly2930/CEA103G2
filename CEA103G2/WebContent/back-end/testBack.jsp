       ...
       <%@ include file="/back-end/includeFile/sidebarBack.file" %>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!--　　　↓↓↓↓↓↓↓↓↓↓內容↓↓↓↓↓↓↓↓↓↓　　　-->
                <!-- Begin Page Content -->
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval=false style="width:500px;height:500px;overflow:hidden;">
				  ...
				  <div class="carousel-inner">
				    <div class="carousel-item active">
				      <img src="/CEA103G2/furPho/furPhoShow.do?fnt_pic_no=1" class="d-block w-100" alt="...">
				    </div>
				    <div class="carousel-item">
				      <img src="/CEA103G2/furPho/furPhoShow.do?fnt_pic_no=2" class="d-block w-100" alt="...">
				    </div>
				    <div class="carousel-item">
				      <img src="/CEA103G2/furPho/furPhoShow.do?fnt_pic_no=3" class="d-block w-100" alt="...">
				    </div>
				  </div>
