	...
	<div id="multiArea">
		<FORM METHOD="post"
			...
			<select size="1" name="fnt_it_no" style="width: 150px; height: 30px;"  id="furIteSelect">
				<option value="">家具品項</option>
				<c:forEach var="furIteVO" items="${furIteDAO.all}">
					<option value="${furIteVO.fnt_it_no}">${furIteVO.fnt_name}</option>
				</c:forEach>
			</select> <select size="1" name="fnt_status" id="fntStatusSelect" 
				style="width: 80px; height: 30px;">
				<option value="">家具狀態</option>
				<option value="0">正常</option>
				<option value="1">維修</option>
				<option value="2">報廢</option>
			</select> <select size="1" name="fnt_rent_status" id="rentStatusSelect" 
				style="width: 80px; height: 30px;">
				<option value="">出租狀態</option>
				<option value="0">未出租</option>
				<option value="1">出租中</option>
			</select> <input type="button" value="查詢" id="multiSearch"> 
...
// 	alert("multiSearch");	
// 	let furCatSelect=$("#furCatSelect").val();
// 	let furIteSelect=$("#furIteSelect").val();
// 	let fntStatusSelect=$("#fntStatusSelect").val();
// 	let rentStatusSelect=$("#rentStatusSelect").val();
	
// 	$.ajax({
<%--           url:"<%=request.getContextPath()%>/furLis/furLis.do", --%>
//           type:"POST",
//           data:{
//           	"action":"compositeQuery",
//          	"furCatSelect":"furCatSelect",
//          	"furIteSelect":"furIteSelect",
//             "fntStatusSelect":"fntStatusSelect",
//           	"rentStatusSelect":"rentStatusSelect",
//           },
