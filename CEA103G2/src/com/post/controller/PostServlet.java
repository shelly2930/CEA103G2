	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("GoToOneContent".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			try {
				...
				String url = "/front-end/post/listOneContent.jsp";
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("/front-end/post/listAllPost.jsp");
		...
		if ("getOne_For_Display".equals(action)) { // 來自select_page.jsp的請求
			...
			try {
				...
				if (!errorMsgs.isEmpty()) {
					RequestDispatcher failureView = req
							.getRequestDispatcher("/back-end/post/select_page.jsp");
					failureView.forward(req, res);
					return;//程式中斷
				}
		...
		if ("getOne_For_Update".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			try {
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("/back-end/post/listAllPost.jsp");
				failureView.forward(req, res);
			}
		}
